...
'''
   This python file mainly contains code for training, testing and evaluation of Pre-trained model based AKE models for T5 Pre-trained model.
   The main function is T5(), called from main().
