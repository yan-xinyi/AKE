...
'''
   This python file mainly contains code for training, testing and evaluation of AKE models for self-attention based Bi-LSTM+CRF.
   The main function is satt_blcrf(), called from main().
      1* Through the TextDataSet (Dataset): build the dictionary for vovabulary and cognitive signals.
      2* Build SATT_BiLSTM_CRF() model
